...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-black border-t border-amber-400/20 text-white/60 pt-16 pb-8">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <div className="flex space-x-4 rtl:space-x-reverse mt-6">
              <Link href="#" className="hover:text-amber-400 transition-colors"><Globe className="w-5 h-5" /></Link>
              <Link href="#" className="hover:text-amber-400 transition-colors"><LinkIcon className="w-5 h-5" /></Link>
              <Link href="#" className="hover:text-amber-400 transition-colors"><Share2 className="w-5 h-5" /></Link>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              ...
              <li><Link href="/admin" className="text-amber-400 font-bold hover:text-white transition-colors">Admin Panel</Link></li>
            </ul>
          </div>
        ...
        <div className="pt-8 border-t border-amber-400/10 text-center text-xs text-white/30">
